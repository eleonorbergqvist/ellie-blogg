        <div style="padding: 15px 150px 15px 150px;">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?= $url('/admintaglist'); ?>">Tags</a></li>
          ...
          <form action="" method="post">
            <div class="form-group row">
              <div class="form-group col-sm-10">
                <label for="create_title">Tagg</label>
                <input name="name" id="create_title" class="form-control" type="text" placeholder="Skriv din tagg här" value="<?= $name ?? '' ?>">
              </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
